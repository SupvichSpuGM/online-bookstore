...
## 2. Class Diagram & Entity Attributes (โครงสร้างความสัมพันธ์ของคลาสข้อมูล)
...
flowchart TD
  ...
  subgraph System_Lane [" Core System Workflow"]
...
flowchart TD
  ...
  subgraph Cloud_Env [" Cloud Service Environment (Express API)"]
    API_Server[" Node.js & Express API (Render Cloud)"]
    JWT_Verify["🛡️ JWT Security Verification"]
    API_Server --> JWT_Verify
  end

  subgraph Data_Env [" Database Environment"]
...
| **นายศุภวิชญ์ เชื้อสาทุม** (67125897) | Super Admin / Backend & DBA | Super Admin Dashboard, MySQL, REST API |
